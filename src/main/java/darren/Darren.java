            ...
            try {
                ...
                switch (command) {
                    ...
                    case "mark":
                        ...
                        if (markIndex == null || markIndex > tasks.size() || markIndex <= 0) {
                    ...
                    case "unmark":
                        ...
                        if (unmarkIndex == null || unmarkIndex > tasks.size() || unmarkIndex <= 0) {
                    ...
                    case "deadline":
                        ...
                        tasks.add(new Deadline(remaining[0].trim(), remaining[1].trim()));
                        saveTasks(storage, tasks);
                        System.out.println(line);
